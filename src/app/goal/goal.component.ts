...
export class GoalComponent implements OnInit {
  ...
  goals: Goal[] = [
    ...
    new Goal(2,'Buy Cookies','I have to buy cookies for the parrot' ,new Date(2020,3,14)),
    new Goal(3,'Get new Phone Case','Diana has her birthday coming up soon' ,new Date(2020,3,14)),
